...
const testimonials = [
  {
    ...
    content: "Depuis que j'ai rejoint Sarematy, mes ventes ont triplé. La livraison intégrée me fait gagner un temps précieux !",
    rating: 5,
    initials: "MD",
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-primary-foreground/80 text-lg mb-8 max-w-lg mx-auto">
                Rejoignez des centaines de vendeurs qui développent leur business avec Sarematy.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
