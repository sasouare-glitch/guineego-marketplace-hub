...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Les remboursements sont traités sous 48 heures ouvrables après validation du litige. Le montant est crédité sur votre mode de paiement d'origine ou votre Wallet Sarematy.",
  },
  {
          ...
          <div className="container-tight relative z-10">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Chez Sarematy, votre sécurité est notre priorité. Chaque transaction est protégée, 
          ...
          <div className="container-tight">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                6 niveaux de protection pour des achats sereins sur Sarematy.
              </p>
            </motion.div>
          ...
          <div className="container-tight">
            ...
            >
              ...
              <p className="text-primary-foreground/80 mb-8 max-w-lg mx-auto">
                De la commande à la livraison, votre satisfaction est garantie. Rejoignez des milliers d'acheteurs qui font confiance à Sarematy.
              </p>
