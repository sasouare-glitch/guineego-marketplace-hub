...
export function ShareStoreCard() {
  ...
  const shareText = encodeURIComponent(`Découvrez ma boutique "${storeName}" sur GuineeGo !`);
  ...
  const socials = [
    ...
    },
    {
      ...
      color: "bg-foreground",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-background">
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Faites connaître votre boutique</p>
        </div>
      </div>
