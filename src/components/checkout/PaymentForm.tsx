...
export const PaymentForm = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Guest info banner for restricted payment methods */}
      {excludeMethods.includes('card') && (
        <div className="flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-950/30 p-4">
          <Info className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 shrink-0" />
          <div className="text-sm">
            <p className="font-medium text-blue-800 dark:text-blue-300">
              Paiement par carte Visa / Mastercard non disponible en mode invité
            </p>
            <p className="text-blue-600 dark:text-blue-400 mt-1">
              Pour payer par carte bancaire, veuillez vous connecter ou créer un compte pour une meilleure sécurité de votre transaction.
            </p>
            <Link 
              to="/auth" 
