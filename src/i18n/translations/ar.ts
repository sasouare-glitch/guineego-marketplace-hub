...
export const ar: TranslationKeys = {
  ...
  hero: {
    ...
    title1: "اشترِ، بِع، استأجر،",
    title2: "اربط غينيا والعالم",
    description: "Makiity يجمع البائعين والمشترين والسعاة والمستثمرين على منصة واحدة. شحن الصين-غينيا، تدريب التجارة الإلكترونية، دفع موبايل آمن.",
  ...
  academy: {
    ...
    courses: "دورات",
    certified: "معتمدين",
    mainTitle: "تعلم التجارة الرقمية",
    mainDescription: "دورات مصممة لأفريقيا، من قبل خبراء أفارقة. تعلم كيفية إنشاء وإدارة وتطوير نشاطك التجاري الإلكتروني بأساليب ملائمة لسوقنا.",
    exploreCourses: "استكشف الدورات",
    viewPricing: "عرض الأسعار",
    course1Title: "إطلاق متجرك الإلكتروني",
    course2Title: "التسويق الرقمي في أفريقيا",
    course3Title: "أصبح محترف مبيعات",
    beginner: "مبتدئ",
    intermediate: "متوسط",
    advanced: "متقدم",
    duration: "المدة",
  ...
  partners: {
    ...
    badge: "الشراكات",
    mainTitle: "انضم إلى مغامرة Makiity",
    mainDescription: "سواء أردت أن تصبح ساعي بريد أو مستثمر، Makiity تقدم لك فرص فريدة للازدهار.",
    becomeCourier: "كن ساعي بريد",
    courierDesc: "انضم إلى شبكة توصيلنا واكسب المال بتوصيل الطرود في كوناكري وفي جميع أنحاء البلاد.",
    courierBenefit1: "دخل مرن حسب جدولك",
    courierBenefit2: "تدريب مجاني متضمن",
    courierBenefit3: "تطبيق جوال مخصص",
    courierBenefit4: "مدفوعات أسبوعية",
    courierCta: "تقدم الآن",
    becomeInvestor: "كن مستثمراً",
    investorDesc: "شارك في نمو التجارة الإلكترونية الغينية. استثمر في نظامنا البيئي وحقق عوائد.",
    investorBenefit1: "عوائد جذابة",
    investorBenefit2: "لوحة تحكم في الوقت الفعلي",
    investorBenefit3: "دعم مخصص",
    investorBenefit4: "تنويع المحفظة",
    investorCta: "اكتشف الفرص",
    testimonial1Quote: "سمح لي Makiity بالعمل وفق إيقاعي وكسب لقمة العيش. النظام شفاف والمدفوعات دائمة في الوقت المحدد.",
    testimonial1Role: "ساعي بريد، كوناكري",
    testimonial2Quote: "نوعت استثماراتي مع Makiity. العوائد جيدة والمتابعة ممتازة. أنصح بها!",
    testimonial2Role: "مستثمرة",
  },

  // CTA Section
  cta: {
    title: "مستعد للانضمام إلى ثورة التجارة الإلكترونية الغينية؟",
    subtitle: "آلاف الغينيين يثقون بالفعل في Makiity للشراء والبيع وتنمية أعمالهم. وأنت؟",
    startBuying: "ابدأ الشراء",
    openShop: "افتح متجري",
    comingSoon: "قريباً على",
    scanToAccess: "امسح للوصول إلى الموقع",
  },
