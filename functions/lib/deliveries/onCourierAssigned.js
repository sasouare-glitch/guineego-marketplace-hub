...
exports.onCourierAssigned = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const notifications_1 = require("../utils/notifications");
const db = admin.firestore();
exports.onCourierAssigned = functions
    .region('europe-west1')
    ...
    if (before.assignedCourier || !after.assignedCourier)
        return;
 ...
 */
async function sendCourierSMS(courierId, missionId, details) {
    ...
    const smsMessage = `GuineeGo ${details.priorityLabel}\n` +
        `Mission: ${missionId}\n` +
...
//# sourceMappingURL=onCourierAssigned.js.map