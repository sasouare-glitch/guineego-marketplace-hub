...
exports.checkMTNPaymentStatus = exports.initiateMTNMoMoPayment = void 0;
 ...
 */
async function getMTNAccessToken(apiUser, apiKey, apiUrl, subscriptionKey) {
 ...
 */
exports.initiateMTNMoMoPayment = functions
    .region('europe-west1')
    ...
    if (!mtn?.subscription_key || !mtn?.api_user || !mtn?.api_key) {
        throw new functions.https.HttpsError('failed-precondition', 'MTN MoMo API non configurée. Contactez l\'administrateur.');
    }
 ...
 */
exports.checkMTNPaymentStatus = functions
    .region('europe-west1')
    .https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Vous devez être connecté.');
...
//# sourceMappingURL=initiateMTNMoMoPayment.js.map