...
exports.initiateOrangeMoneyPayment = void 0;
 ...
 */
async function getOrangeAccessToken(clientId, clientSecret, apiUrl) {
 ...
 */
exports.initiateOrangeMoneyPayment = functions
    .region('europe-west1')
    ...
    if (!omConfig?.client_id || !omConfig?.client_secret || !omConfig?.merchant_key) {
        throw new functions.https.HttpsError('failed-precondition', 'Orange Money API non configurée. Contactez l\'administrateur.');
    }
...
//# sourceMappingURL=initiateOrangeMoneyPayment.js.map