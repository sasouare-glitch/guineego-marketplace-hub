...
exports.batchCourierPayout = exports.onMissionDelivered = exports.payCourier = void 0;
    ...
    try {
        return await db.runTransaction(async (transaction) => {
            ...
            if (mission.status !== 'delivered') {
                throw new functions.https.HttpsError('failed-precondition', 'La mission n\'est pas encore terminée');
            }
            // Check if already paid
            if (mission.courierPaymentStatus === 'paid') {
                throw new functions.https.HttpsError('already-exists', 'Le coursier a déjà été payé pour cette mission');
            }
            const courierId = mission.assignedCourier;
            if (!courierId) {
                throw new functions.https.HttpsError('failed-precondition', 'Aucun coursier assigné à cette mission');
            }
            // Calculate payment
        ...
        throw new functions.https.HttpsError('internal', 'Erreur lors du paiement du coursier');
    }
});
/**
 * Auto-pay courier when mission is marked as delivered
 */
exports.onMissionDelivered = functions
    .region('europe-west1')
 ...
 */
exports.batchCourierPayout = functions
    .region('europe-west1')
    .https.onCall(async (data, context) => {
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', 'Erreur lors du paiement groupé');
    }
});
/**
 * Calculate courier payment amount with all bonuses
 */
function calculateCourierPaymentAmount(mission) {
    const breakdown = {};
    // Base payment
...
//# sourceMappingURL=courierPayments.js.map