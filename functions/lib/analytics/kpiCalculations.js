...
exports.calculateCloserPerformance = exports.calculateCourierPerformance = exports.dailyRevenueReport = exports.calculateEcomPerformance = void 0;
 ...
 */
exports.calculateEcomPerformance = functions
    .region('europe-west1')
    ...
    try {
        ...
        const cartsSnap = await db.collection('carts')
            ...
            .get();
        // Customer analytics
        const customerIds = new Set(completedOrders.map((o) => o.customerId));
 ...
 */
exports.dailyRevenueReport = functions
    .region('europe-west1')
 ...
 */
async function updateRollingMetrics(todayReport) {
    const now = new Date();
 ...
 */
exports.calculateCourierPerformance = functions
    .region('europe-west1')
    .https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Authentification requise');
 ...
 */
exports.calculateCloserPerformance = functions
    .region('europe-west1')
    .https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Authentification requise');
...
//# sourceMappingURL=kpiCalculations.js.map