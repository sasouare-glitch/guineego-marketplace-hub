...
export const retrySmsScheduled = functions
  ...
  .onRun(async () => {
    ...
    const senderName = config.senderName || 'Sarematy';
    ...
    for (const doc of eligible) {
      ...
      const message = data.message || `[Sarematy] Ceci est un SMS de test. Votre configuration Orange SMS fonctionne correctement ! ✅`;
